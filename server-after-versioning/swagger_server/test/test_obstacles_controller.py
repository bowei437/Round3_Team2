...
class TestObstaclesController(BaseTestCase):
    ...
    def test_add_obstacle(self):
        ...
        """
        obstacle = Obstacle()
        response = self.client.open('/v2/id&#x3D;{problem_id}/Obstacles/ver&#x3D;{version}/'.format(problem_id=56, version=1.2),
                                    method='POST',
    ...
    def test_delete_obstacle(self):
        ...
        Delete Obstacle
        """
        response = self.client.open('/v2/id&#x3D;{problem_id}/Obstacles/obstacle_id&#x3D;{obstacle_id}/ver&#x3D;{version}/'.format(problem_id=56, obstacle_id=56, version=1.2),
                                    method='DELETE')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
    ...
    def test_get_obstacle(self):
        ...
        Obstacles
        """
        response = self.client.open('/v2/id&#x3D;{problem_id}/Obstacles/obstacle_id&#x3D;{obstacle_id}'.format(problem_id=56, obstacle_id=56),
                                    method='GET')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
    ...
    def test_get_obstacles(self):
        ...
        Obstacles
        """
        response = self.client.open('/v2/id&#x3D;{problem_id}/Obstacles'.format(problem_id=56),
                                    method='GET')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
