...
class Obstacle(Model):
    ...
    """
    def __init__(self, obstacle_id: int=None, obstacle_info: List[Coordinate]=None):
        """
        ...
        :type obstacle_info: List[Coordinate]
        """
        self.swagger_types = {
            'obstacle_id': int,
    ...
    @property
    def obstacle_info(self) -> List[Coordinate]:
        """
    ...
    def obstacle_info(self, obstacle_info: List[Coordinate]):
        """
